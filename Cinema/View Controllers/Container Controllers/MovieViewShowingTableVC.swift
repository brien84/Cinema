...
class MovieViewShowingTableVC: UITableViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        print("MovieViewShowingTableVC Appeared")
    }
    
    override func viewWillDisappear(_ animated: Bool) {
        super.viewWillDisappear(animated)
        print("MovieViewShowingTableVC Disappeared")
    }
